...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  shortcuts: 'client-side interface-typed browser service — packages/client/ui-command-palette/README.md owns the API',
  ...
  sessionFileChanges: 'client-side interface-typed change index the deliverables plugin provides — packages/client/ui-sidebar-documentpreview/README.md owns the API',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  WorkspaceFileWriteResult: 'Host workspace file endpoint contract is owned by packages/api/workspace-files/README.md',
