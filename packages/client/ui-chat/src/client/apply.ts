      ...
      inject: (sessionId: SessionId): ChatViewInjected => {
        ...
        return {
          ...
          openFile: async (path, options) => {
            ...
            // A requested change rides the address as a navigation parameter,
            // like a line: the file is one piece of content whether it is read
            // whole or as the change this Turn applied.
            const params = {
              ...options?.line === undefined ? {} : { line: options.line },
              ...options?.changeSeq === undefined ? {} : { changeSeq: options.changeSeq },
              ...options?.hunk === undefined ? {} : { hunk: options.hunk },
            }
