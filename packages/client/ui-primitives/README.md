...
| `TerminalBlock`, `ReadBlock`, `DiffBlock`, `DiffSplitBlock`, `SearchBlock`, `WebBlock` | The agent-output card matching each tool-result intent; the two diff surfaces draw the same hunks in one column or in two. |
