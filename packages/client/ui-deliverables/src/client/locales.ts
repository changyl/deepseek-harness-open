...
export const zh = {
  ...
  'review.acceptTurn': '接受本轮改动',
  'review.revertTurn': '回滚本轮改动',
  'review.pending': '处理中…',
  'review.done': '已处理本轮改动',
  'review.failed': '操作失败',
...
export const en: Record<DeliverablesKey, string> = {
  ...
  'review.acceptTurn': 'Accept this turn\u2019s changes',
  'review.revertTurn': 'Revert this turn\u2019s changes',
  'review.pending': 'Working…',
  'review.done': 'This turn\u2019s changes are decided',
