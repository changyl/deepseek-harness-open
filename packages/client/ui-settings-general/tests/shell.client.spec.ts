 ...
 * ui-settings-models, ui-settings-plugins, ui-agent-preset, ui-usage,
 * ui-project, and ui-effectiveness. A plugin adding a section changes this
 * list.
 */
const PRODUCT_SECTIONS: readonly string[] = ['general', 'models', 'plugins', 'agent-presets', 'usage', 'projects', 'effectiveness']
