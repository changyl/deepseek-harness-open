...
import usageRemote from '@deepseek-ai/dsh-api-usage/remote'
import projectRemote from '@deepseek-ai/dsh-api-project/remote'
import effectivenessRemote from '@deepseek-ai/dsh-api-effectiveness/remote'
...
export type {} from '@deepseek-ai/dsh-api-usage/remote'
export type {} from '@deepseek-ai/dsh-api-project/remote'
export type {} from '@deepseek-ai/dsh-api-effectiveness/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      ...
      subagentsRemote, sessionRemote, usageRemote, projectRemote, effectivenessRemote, workspaceRemote, workspaceFilesRemote,
    ]) {
