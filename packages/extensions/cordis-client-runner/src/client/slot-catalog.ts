...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-task-report TaskReportCard',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-effectiveness EffectivenessPanel',
      'client-ui-project ProjectPanel',
      'client-ui-usage UsagePanel',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-command-palette CommandPalette id \'command-palette\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'sidebar\' (client-ui-sidebar), so it exists while that entry is mounted',
    occupants: [
      'client-ui-effectiveness EffectivenessPanelIcon',
      'client-ui-project ProjectPanelIcon',
      'client-ui-usage UsagePanelIcon',
    ],
    replaceRisk: 'none',
