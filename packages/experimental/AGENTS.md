...
These rules supplement the [package rules](../AGENTS.md). The [experimental Agent Teams publication decision](../../.agents/notes/implemented/architecture/2026-08-18-experimental-agent-teams-packages.md) records the retired public-exception policy.
...
- Every package here uses the `@deepseek-ai/dsh-experimental-*` npm prefix. Packages are private by default and omit `publishConfig`.
